...
//    public SampleMecanumDrive drive = null;
    ...
    public ServoGate servoGate = null;
...
//        rearDistance = hwMap.get(Rev2mDistanceSensor.class, "rearDistance");
        ...
        artifactIntake = new ArtifactIntake(opMode, this);
        artifactIntake.init();

        //Servo Gate "servoGate"
        gateServo = hwMap.get(Servo.class, "servoGate");
        leftGateServo = hwMap.get(Servo.class, "leftServoGate");
        servoGate = new ServoGate(opMode, this);
        servoGate.init();
...
//        robo130.doLoop();
    ...
    public void stop() {
        robo130.showAllUnfinishedCommands();
        closeCSVFile();
        closeLogFile();
        closeCSVTimersFile();
    }
    ...
    private void logCSVData() {
        ...
        if (csvScanNumber % 5 == 0) {
            double[] data = {currentTime,
                    ...
                    drive.leftBack.getTargetPosition(),
                    drive.leftBack.getCurrentPosition(),
                    drive.leftBack.getPower(),
                    drive.leftBack.getVelocity(),
                    ...
                    drive.rightBack.getTargetPosition(),
                    drive.rightBack.getCurrentPosition(),
                    drive.rightBack.getPower(),
                    drive.rightBack.getVelocity(),
